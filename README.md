<div align="center">
  ...
  [![Build Status](https://github.com/jeffphp/lingua-go/workflows/build/badge.svg?branch=main)](https://github.com/jeffphp/lingua-go/actions?query=workflow%3A%22build%22+branch%3Amain)
  ...
  [![Go Reference](https://pkg.go.dev/badge/github.com/jeffphp/lingua-go.svg)](https://pkg.go.dev/github.com/jeffphp/lingua-go)
  [![Go Report Card](https://goreportcard.com/badge/github.com/jeffphp/lingua-go)](https://goreportcard.com/report/github.com/jeffphp/lingua-go)
...
[`/accuracy-reports`](https://github.com/jeffphp/lingua-go/tree/main/cmd/accuracy-reports).
...
## 7. How to add it to your project?
    ...
    go get github.com/jeffphp/lingua-go
...
```
git clone https://github.com/jeffphp/lingua-go.git
cd lingua-go
go build
```
...
Otherwise [`Unknown`](https://github.com/jeffphp/lingua-go/blob/main/language.go#L107) will be
...
[`ConfidenceValue`](https://github.com/jeffphp/lingua-go/blob/main/confidence.go#L21) 
...
In the example above, a slice of [`DetectionResult`](https://github.com/jeffphp/lingua-go/blob/main/result.go#L22)
...
Take a look at the [planned issues](https://github.com/jeffphp/lingua-go/milestone/5).

## 11. Contributions

Any contributions to *Lingua* are very much appreciated. Please read the instructions
in [`CONTRIBUTING.md`](https://github.com/jeffphp/lingua-go/blob/main/CONTRIBUTING.md)
